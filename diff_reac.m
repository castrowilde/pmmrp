...
L = 200; % number of layers
eps = 0.001; % 0 < eps << 1
a = 0.4; % threshold
b = 20; % 10 for mono-stable, 20 for bi-stable

U(1:m, 1:n) = A(1:m, 1:n) * (1.0 + 0.05) - 0.05; % every pixel gets its own value by brightness
V(1:m, 1:n) = zeros(m,n); % initial V is 0 for all pixels
